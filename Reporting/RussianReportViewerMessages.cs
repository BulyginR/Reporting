...
namespace AdvancedReportViewer.Utils
{
    /// <summary>
    ...
    public class RussianReportViewerMessages : IReportViewerMessages
    {
        ...
        public RussianReportViewerMessages()
        {
            ...
            NullCheckBoxText = @"[ПУСТО]";
            NullCheckBoxToolTip = @"Установить для параметра значение [ПУСТО]";
            NullValueText = @"";
            PageOf = @"из";
            ...
            ZoomToPageWidth = @"Ширина страницы";
            ZoomToWholePage = @"Вся страница";
        }
